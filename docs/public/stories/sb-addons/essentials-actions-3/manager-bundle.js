  ...
  (() => {
    ...
    function z(e) {
      ...
      return (
        (z = function (n) {
          ...
          function a() {
            return I(n, arguments, H(this).constructor);
          }
          return (
    ...
    function At(e, t, r, n) {
      if (
        ...
        return n >= 1 ? $(e, t, r) : "rgba(" + U(e, t, r) + "," + n + ")";
    ...
    var Br = F(lt)({ margin: 0, padding: "10px 5px 20px" }),
      Fr = ke(({ theme: e, ...t }) =>
        o.createElement(Ir, {
      ...
      Ur = class extends Ae {
        ...
        componentDidMount() {
          ...
          e.on(pe, this.addAction), e.on(V, this.handleStoryChange);
        }
        componentWillUnmount() {
          this.mounted = !1;
          let { api: e } = this.props;
          e.off(V, this.handleStoryChange), e.off(pe, this.addAction);
        }
        render() {
