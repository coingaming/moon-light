...
export default async function Sidebar() {
  return (
    <aside className="fixed top-[4.5rem] h-screen flex flex-shrink-0 flex-col w-72 flex-grow gap-6 pt-6 pb-28 lg:pb-20 px-5 lg:px-8 bg-goku overflow-y-scroll border-e border-beerus">
