...
const ReleaseSidebar = ({
  ...
  items.length && <aside className="fixed top-[72px] end-0 w-64 pt-6 px-3 bg-goku overflow-y-scroll border-s border-beerus hidden md:block">
    <nav className="flex flex-col gap-5" aria-label="Release navigation">
