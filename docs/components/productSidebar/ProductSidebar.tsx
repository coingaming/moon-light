...
export default async function ProductSidebar({ name, contents }: any) {
  ...
  return (
    <aside className="fixed flex flex-shrink-0 h-fit top-[4.5rem] end-0 w-72 flex-grow bg-goku overflow-y-scroll hidden lg:inline h-full">
      <nav className="flex flex-col gap-6" aria-label="Sidebar">
        <div className="flex flex-col gap-2 border-s border-beerus pt-4 px-8 ">
